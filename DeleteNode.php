    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Form">
		  ...
		  <ul class="sidenav-second-level collapse" id="collapseForm">
			...
			<li>
              <a href="subnodeform.php">Delete SubNode</a>
            </li>
          </ul>  
        </li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Delete SubNode<small></small></h2>           
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                
					  <form name="subnode" method="post" action="php/DeleteSubNode.php">
						<?php
									require "php/Opendb.php";
									...
									while ($row = mysqli_fetch_array($data)) 
										{
											array_push($source, $row['Sub_Name']);
										}
						...
						?>
							...
							<span> SubNode : </span> 
							<select name='SubNode' id='SubNode'>
